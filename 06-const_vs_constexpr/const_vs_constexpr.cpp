...
// In the context of classes, static variables are shared among all instances of the class. 
// They are associated with the class rather than with a specific object instance.
