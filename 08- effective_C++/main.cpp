...
// a constant pointer (const char*) to constant characters 
// C-style strings have limitations such as difficulty in handling dynamic and potential buffer overflows 
const char* const myString1 = "Pooya";

// const std::string : It manages memory automatically, adjusts its size dynamically, and provides a more
// convenient and safer interface for string manipulation.
const std::string myString2{"Pooya"};
